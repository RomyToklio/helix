...
The script [extract-osx-sdk.sh](https://github.com/projecthelixcoin/helix/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
helix/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/projecthelixcoin/helix/blob/master/doc/README_osx.md) for troubleshooting tips.