...
The build script we'll be using is contained in the HELIX github repository ([contrib/gitian-build.py](https://github.com/projecthelixcoin/helix/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the HELIX repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/projecthelixcoin/HELIX/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, helix-detached-sigs, and helix GitHub repos.
